...
//  Scrumdinger
//
//  Created by Cory Sebastian on 5/24/21.
//
...
struct MeetingTimerView: View {
    ...
    var body: some View {
        ZStack {
            Circle()
                .strokeBorder(lineWidth: 24.0, antialiased: /*@START_MENU_TOKEN@*/true/*@END_MENU_TOKEN@*/)  // putting text and circle inside of a Zstack makes the text appear inside the circle! (does not matter which comes first)
            VStack {
